...
{(step.step_type === 'MESSAGE' || step.step_type === 'QUESTION_TEXT') && (
    <>
        <Handle
            ...
            id="next_step_id"
            style={{ background: '#5cb85c', left: '50%' }}
        />
        <div
            style={{
                position: 'absolute',
            ...
            {step.step_type === 'QUESTION_TEXT' && step.db_query && (
                 <>
                    <Handle
                        ...
                        style={{ top: '60%', background: '#d9534f' }}
                    />
                    <div style={{ position: 'absolute', right: -65, top: '58%', fontSize: '10px', color: '#d9534f', transform: 'translateY(-50%)' }}>
                        Falha DB
                    </div>
                 </>
            )}
